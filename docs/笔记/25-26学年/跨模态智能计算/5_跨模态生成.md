...
<img src="./images/chp3_4_5/image-9.png" alt="alt text" style="zoom:33%;" />
...
<img src="./images/chp3_4_5/image-10.png" alt="alt text" style="zoom:33%;" />
...
<img src="./images/chp3_4_5/image-11.png" alt="alt text" style="zoom:33%;" />

建立一个图神经网络，通过 GCN 将不同的定位区域链接起来。最后后方接 Decoder 来进行文本生成：

<img src="./images/chp3_4_5/image-12.png" alt="alt text" style="zoom: 50%;" />
...
<img src="./images/chp3_4_5/image-13.png" alt="alt text" style="zoom:33%;" />

### GAN

GAN 的缺点是存在模式坍塌问题（生成器认为只要能骗过判别器 D 就够了，而不需要覆盖所有真实分布）导致 GAN 的方式生成的图片的**多样性**可能较低；GAN 很难对风格进行精准控制，如笔触或色彩。

<img src="./images/chp3_4_5/image-20260525171658173.png" alt="alt text" style="zoom:33%;" />
...
<img src="./images/chp3_4_5/image-17.png" alt="alt text" style="zoom:33%;" />
...
<img src="./images/chp3_4_5/image-14.png" alt="alt text" style="zoom:33%;" />

<img src="./images/chp3_4_5/image-15.png" alt="alt text" style="zoom: 25%;" />
...
<img src="./images/chp3_4_5/image-16.png" alt="alt text" style="zoom:50%;" />

这里的 $\{\beta_t\}_{t=1}^T$ 是每一步所采用的方差，介于 0~1。越往后 timestep 对应的 $\beta$ 值越大，即越往后采用越大的方差，整个扩散过程是一个携带参数的马尔可夫链：

<img src="./images/chp3_4_5/image-18.png" alt="alt text" style="zoom:50%;" />
...
<img src="./images/chp3_4_5/image-19.png" alt="alt text" style="zoom:50%;" />

上述推导过程用到了两个方差不同的高斯分布相加等于一个新的高斯分布，对应噪声 $\epsilon$ 。于是我们得到

<img src="./images/chp3_4_5/image-20.png" alt="alt text" style="zoom:50%;" />

我们可以看到组合系数 $\sqrt{\bar{\alpha}_t}$ 和 $\sqrt{ 1 - \bar{\alpha}_t}$，它们的平方和等于1。

在加噪完后，我们开始分析如何进行去噪过程。我们可以直接通过上述公式从 x_t 直接求解得到 x_0:

<img src="./images/chp3_4_5/image-21.png" alt="alt text" style="zoom: 33%;" />

这里的 $\epsilon$ 是所有噪声的混合。我们的目标就是要求解这个噪声，但是直接求解它是不可行的，我们可以通过神经网络来预测，这种方式被称为 `x0-prediction`（直接预测原始数据）风格，而不是常见的 `ε-prediction`（预测噪声）风格。`x0-prediction` 在数据量小、信噪比不稳定时有时更稳，这里暂时不探讨它。

下面转而研究每一步如何预测噪声：

<img src="./images/chp3_4_5/image-22.png" alt="alt text" style="zoom:33%;" />
...
<img src="./images/chp3_4_5/image-25.png" alt="alt text" style="zoom: 50%;" />

根据贝叶斯公式：

<img src="./images/chp3_4_5/image-24.png" alt="alt text" style="zoom:50%;" />

将下面两个式子带入上式：

<img src="./images/chp3_4_5/image-26.png" alt="alt text" style="zoom:50%;" />

化简后得到：

<img src="./images/chp3_4_5/image-27.png" alt="alt text" style="zoom:33%;" />
...
<img src="./images/chp3_4_5/image-28.png" alt="alt text" style="zoom: 50%;" />

将上式带入均值式子得到：

<img src="./images/chp3_4_5/image-29.png" alt="alt text" style="zoom: 33%;" />
...
<img src="./images/chp3_4_5/image-30.png" alt="alt text" style="zoom:33%;" />

构造损失函数：

<img src="./images/chp3_4_5/image-31.png" alt="alt text" style="zoom:33%;" />

把预测的 $\mu_\theta$ 和真实的 $\mu_t$ 带入，得到：

<img src="./images/chp3_4_5/image-32.png" alt="alt text" style="zoom:33%;" />

化简后得到：

<img src="./images/chp3_4_5/image-33.png" alt="alt text" style="zoom:33%;" />

剥离前面的常数后得到：

<img src="./images/chp3_4_5/image-34.png" alt="alt text" style="zoom: 50%;" />
...
<img src="./images/chp3_4_5/image-35.png" alt="alt text" style="zoom:50%;" />
...
<img src="./images/chp3_4_5/image-56.png" alt="alt text" style="zoom:33%;" />

对公式两边同时取对数，然后对 x 求梯度：

<img src="./images/chp3_4_5/image-57.png" alt="alt text" style="zoom:33%;" />
...
<img src="./images/chp3_4_5/image-58.png" alt="alt text" style="zoom:33%;" />
